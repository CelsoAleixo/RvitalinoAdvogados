...
export function StorytellingIntro() {
  ...
  return <section className="relative py-16 md:py-24 overflow-hidden">
      ...
      <div className="container-site relative z-10 max-w-5xl">
        ...
        {/* Title */}
        <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl text-center leading-[1.15] mb-14 animate-fade-in" style={{
        animationDelay: "0.1s"
      }}>
        ...
        {/* Block 1: Image + Text */}
        <div className="animate-fade-in grid md:grid-cols-2 gap-6 mb-6" style={{
        animationDelay: "0.2s"
      }}>
          ...
          <div className="rounded-2xl bg-secondary/30 border border-border/30 p-6 md:p-8 flex flex-col justify-center space-y-4">
            {block1.map((text, i) => <p key={i} className="text-base md:text-lg text-muted-foreground leading-relaxed text-mobile-justified">
                {text}
              </p>)}
          </div>
        </div>
        ...
        {/* Highlight card */}
        <div className="animate-fade-in relative rounded-2xl overflow-hidden mb-6" style={{
        animationDelay: "0.4s"
      }}>
