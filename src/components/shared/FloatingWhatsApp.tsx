    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      {showTooltip && !dismissed && (
        <div className="relative animate-fade-in">
          <div className="bg-white rounded-xl shadow-2xl p-4 max-w-[280px] border border-border">
            <button 
              onClick={() => {
                setShowTooltip(false);
                setDismissed(true);
      ...
      <a
        ...
        className="group relative flex items-center justify-center w-14 h-14 md:w-16 md:h-16 bg-[#25D366] rounded-full shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 animate-fade-in"
