  ...
  return (
    <Layout>
      <PageSEO
        ...
        jsonLd={breadcrumbSchema([{ name: "Início", url: "/" }, { name: "Atuação", url: "/atuacao" }, { name: "Assessoria Jurídica Empresarial", url: "/atuacao/assessoria-juridica-empresarial" }])}
      />
      {/* Hero Section */}
      <section className="relative min-h-[70vh] flex items-center overflow-hidden">
        <div
          ...
          role="img"
          aria-label="Assessoria Jurídica Empresarial"
      ...
      <section className="section-padding">
        <div className="container-site">
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            {/* Nosso Diferencial */}
            <div className="bg-[hsl(var(--card-dark,_140_30%_12%))] rounded-2xl p-8 md:p-10 text-foreground">
              <h2 className="font-serif text-2xl md:text-3xl mb-6 text-accent">Como protegemos e fortalecemos seu negócio</h2>
              <div className="space-y-4 text-foreground/80 leading-relaxed">
                <p>
                  Não acreditamos em soluções genéricas. Cada empresa tem sua realidade, seus desafios e suas metas. Por isso, nosso trabalho começa com uma <strong className="text-foreground">escuta atenta</strong> e uma <strong className="text-foreground">análise profunda</strong> do cenário jurídico do seu negócio.
                </p>
                <p>
                  Atuamos de forma <strong className="text-foreground">preventiva e consultiva</strong>, antecipando riscos antes que se tornem problemas. E quando o conflito é inevitável, entramos com <strong className="text-foreground">estratégia, agilidade e determinação</strong> para defender os interesses da sua empresa em todas as instâncias.
                </p>
                <p>
                  Nosso compromisso é ser mais do que um escritório de advocacia — queremos ser o <strong className="text-foreground">parceiro jurídico estratégico</strong> que sua empresa precisa para crescer com segurança e confiança.
                </p>
              </div>
            </div>
            ...
            <p className="text-muted-foreground leading-relaxed text-lg italic border-l-4 border-accent pl-6 text-center">
              Sua empresa tem direito a uma assessoria jurídica que entende de negócios, fala a sua língua e está comprometida com os seus resultados. <strong className="text-foreground">Vamos conversar?</strong>
            </p>
          </div>
        </div>
      </section>
