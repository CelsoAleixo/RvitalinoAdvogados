...
const diferenciais = [
  {
    ...
    description:
      "Somos referência nacional em Recuperação Judicial, reconhecidos como o melhor do Brasil na condução desses processos. Com excelência e transparência, estruturamos planos sólidos, negociamos com credores e asseguramos que empresas em crise reorganizem suas atividades, preservem sua continuidade e retomem o crescimento com segurança jurídica. Há muitos anos atuamos de forma única nesse contexto, consolidando nossa liderança e credibilidade no mercado.
",
  },
  {
    icon: Users,
    ...
    description:
      "O atendimento ao cliente oferecido pelo nosso escritório será sempre por um profissional da área do direito que o cliente estiver necessitando, sempre que possível atendimento pessoal para saneamento e esclarecimento de dúvidas.",
  },
];
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="bg-card rounded-lg p-6 border border-border">
              ...
              <ul className="space-y-2 text-muted-foreground text-sm">
                <li>Empresas concessionárias de transporte público urbano e rodoviário</li>
                <li>Empresas de mineração de ferro e manganês</li>
                <li>Empresas de mineração de granito e pedras preciosas</li>
                <li>Empresas corporativas de agronegócio e recuperação judicial</li>
                <li>Indústria de alimentos (charque)</li>
                <li>Restaurantes</li>
                <li>Projetos de PPP – Parceria Público-Privada na área de iluminação</li>
                <li>Empresas concessionárias</li>
              </ul>
            </div>
