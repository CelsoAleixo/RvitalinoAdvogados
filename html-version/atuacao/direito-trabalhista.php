...
<section class="hero" style="min-height:70vh">
  <div class="hero__bg"><img src="<?php echo $base; ?>/assets/areas/direito-trabalhista-hero.jpg" alt="Direito Trabalhista"></div>
  ...
  <div class="hero__content"><div class="container" style="padding-top:5rem;padding-bottom:5rem">
    <div class="breadcrumb" style="color:rgba(255,255,255,.74);margin-bottom:1rem"><a href="<?php echo $base; ?>/index.php">Início</a><span class="sep">/</span><a href="<?php echo $base; ?>/atuacao.php">Áreas de Atuação</a><span class="sep">/</span><span class="current">Direito Trabalhista</span></div>
